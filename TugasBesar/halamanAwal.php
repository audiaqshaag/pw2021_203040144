...
<body>
    ...
    <div class="isi w3-animate-top">
        ...
        <a class="btn btn-secondary" style="margin-top:3%;margin-right:9%;float:right;" href="registrasi.php">Registrasi</a>
        <a class="btn w3-green" style="margin-top:3%;margin-right:1%;float:right;" href="login.php">Log in</a>
        <br>
        <div id="header">
