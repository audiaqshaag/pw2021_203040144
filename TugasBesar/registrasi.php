...
<body>
    ...
    <div class="isi w3-animate-top">
        ...
        <div id="container">
            ...
            <br>
            <br>
            <form action="fungsiInsertAkun.php" method="POST" enctype="multipart/form-data">
                <div class="formtambah" style="width:50%;">
                    ...
                    <div class="formpassword">
                        ...
                        <input class="mb-3 form-control" type="password" name="pass" required><br><br>
                    </div>

                    <div class="formpassword">
                        <label>Sebagai (1 untuk admin / 2 untuk user biasa) :</label>
                        <input class="mb-3 form-control" type="text" name="akun" required><br><br>
                    </div>
                ...
                <input style="width:50%;margin-left:25%;" class="btn w3-green" type="submit" name="regist" value="Buat Akun"></input>
                <br><br><br>
